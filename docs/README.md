# Checkout UI Settings for Storecomponents

This project implements Checkout UI Settings in the account storecomponents and can be used as an implementation example.
